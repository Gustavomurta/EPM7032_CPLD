...
In phase 1, I only activated NTPW and then immediately activated 12V on EDIT/VPP.
Notice that the SDOUTA and SDOUTB pins were low (0) before this activation.
...
In the programmer's project, I will have to develop several phases. Some of them more complex.
Stay tuned for the development of the other phases.
